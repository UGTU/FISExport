namespace Fdalilib.XMLCODE
{
    ...
    public partial class PackageDataApplicationApplicationCommonBenefitDocumentReasonMedicalDocuments1
    {
        ...
        private PackageDataApplicationApplicationCommonBenefitDocumentReasonMedicalDocumentsBenefitDocument1
            benefitDocumentField;

        private TAllowEducationDocument allowEducationDocumentField;

        /// <remarks/>
        public PackageDataApplicationApplicationCommonBenefitDocumentReasonMedicalDocumentsBenefitDocument1
            BenefitDocument
        {
